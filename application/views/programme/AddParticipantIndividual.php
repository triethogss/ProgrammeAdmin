...
<div class="row" style="border-bottom:2px solid #cccccc;">
  ...
  <div class="col-md-3">
	...
	<div class="col-md-6">
      ...
      <a href="<?php echo site_url('programme/addParticipantIndividual');?>"><button type="button" class="btn btn-default selected">Participant</button></a>
  ...
  <div class="col-md-6">
    <div class="table-responsive">
      <table class="table table-bordered table-striped" style="margin-top:10px;">
          ...
          <!-- Additional resources and/ or merchandises: -->
          <tr>
            <td>Additional resources and/ or merchandises:</td>
            <td>
              <div class='row' style='margin-left:0px;margin-bottom:5px;'>
                  ...
                  <div>         
                    ...
                    <button type='button' class='btn btn-default btn-del-last-resources'><span class='glyphicon glyphicon-trash'></span></button>
                  </div> 
              </div> 
          ...
          <tr>
            <td colspan="2" style="text-align:center;">
              <a href="<?php echo site_url('programme/showParticipant');?>"><button type="button" class="btn btn-primary" >Add Participant</button></a>
            </td>
          </tr>
      </table>
  </div>
